...
void sipXtapiTestSuite::testLineAPI_Add() 
{
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      // Re-Add Line
      CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst1, "sip:bandreasen@pingtel.com", &hLine2), SIPX_RESULT_FAILURE);
...
void sipXtapiTestSuite::testLineAPI_Remove() 
{
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst1, "sip:removeme@pingtel.com", &hLine), SIPX_RESULT_SUCCESS);    
      CPPUNIT_ASSERT(hLine);
...
void sipXtapiTestSuite::testLineAPI_Credential() 
{
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      // Add a line to remove
      CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst1, "sip:credential@pingtel.com", &hLine), SIPX_RESULT_SUCCESS);
      CPPUNIT_ASSERT(hLine);
...
void sipXtapiTestSuite::testLineAPI_Get() 
{
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      CPPUNIT_ASSERT_EQUAL(sipxLineGet(g_hInst1, hLines, 32, &nLines), SIPX_RESULT_SUCCESS);
      for (i=0; i<nLines; i++) 
      {
      ...
      CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst1, szURI, &hLine), SIPX_RESULT_SUCCESS);    
      CPPUNIT_ASSERT(hLine);
...
void sipXtapiTestSuite::testLines() 
{
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst1, URL_GEORGE_AT_JUNGLE, &hLineGeorge), SIPX_RESULT_SUCCESS);
      CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst1, URL_JANE_AT_JUNGLE, &hLineJane), SIPX_RESULT_SUCCESS);
      ...
      */ 
      sipxEventListenerAdd(g_hInst1, linetest_verify_lineurl, (void*)URL_JANE_AT_JUNGLE);
      ...
      CPPUNIT_ASSERT_EQUAL(sipxEventListenerRemove(g_hInst1, linetest_verify_lineurl, (void*)URL_JANE_AT_JUNGLE), SIPX_RESULT_SUCCESS);
...
{    
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      CPPUNIT_ASSERT_EQUAL(sipxEventListenerAdd(g_hInst1, lineCallback, NULL), SIPX_RESULT_SUCCESS);
      ...
      SIPX_LINE hLine;
      CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst1, "sip:115@hopefullythisisnotarealdomain.com", &hLine), SIPX_RESULT_SUCCESS);
      ...
      CPPUNIT_ASSERT_EQUAL(sipxEventListenerRemove(g_hInst1, lineCallback, NULL), SIPX_RESULT_SUCCESS);
      CPPUNIT_ASSERT_EQUAL(sipxLineRemove(hLine), SIPX_RESULT_SUCCESS);
   }
