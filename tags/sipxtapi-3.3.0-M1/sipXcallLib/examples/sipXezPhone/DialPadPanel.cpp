...
void DialPadPanel::createPhoneButton(int index, const wxString& bmpFile, const wxString& bmpDown, const int btnID, const int row, const int col, const SIPX_TONE_ID toneId, const char charRepresentation)
{
