...
void sipXtapiTestSuite::testBlindTransferSuccess() 
{
   ...
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      sipxRC = sipxEventListenerAdd(g_hInst1, UniversalEventValidatorCallback, &validatorTransferController);
      ...
      // Create Lines
      sipxRC = sipxLineAdd(g_hInst1, "sip:foo@127.0.0.1:8000", &hLine);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      ...
      CPPUNIT_ASSERT(bRC);
      validatorTransferController.validateCallMediaStartEvents();
      ...
      CPPUNIT_ASSERT(bRC);
      validatorTransferee.validateCallMediaStartEvents();
      ...
      CPPUNIT_ASSERT(bRC);
      validatorTransferController.validateCallMediaStopEvents();
      ...
      bRC = validatorTransferee.waitForCallEvent(g_hAutoAnswerCallbackLine, g_hAutoAnswerCallbackCall, CALLSTATE_BRIDGED, CALLSTATE_CAUSE_NORMAL);
      CPPUNIT_ASSERT(bRC);
      ...
      CPPUNIT_ASSERT(bRC);
      validatorTransferTarget.validateCallMediaStartEvents();
      ...
      validatorTransferee.validateCallMediaStopEvents();
      ...
      CPPUNIT_ASSERT(bRC);
      validatorTransferTarget.validateCallMediaStopEvents();
      ...
      // Remove Listeners
      sipxRC = sipxEventListenerRemove(g_hInst1, UniversalEventValidatorCallback, &validatorTransferController);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
...
void sipXtapiTestSuite::testBlindTransferFailureBusy() 
{
   ...
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      sipxRC = sipxCallCreate(g_hInst1, hLine, &hTransferee);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      sipxRC = sipxCallConnect(hTransferee, "blah:foo@127.0.0.1:9100", SIPX_FOCUS_MANUAL);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      ...
      CPPUNIT_ASSERT(bRC);
      // newcall always generates media remote start, since early media could be flowing from remote party
      ...
      CPPUNIT_ASSERT(bRC);
      // local stop is never fired, call is never established, and doesn't gain focus
      // so the original call will have focus if transfer failed
      ...
      CPPUNIT_ASSERT(bRC);
      bRC = validatorTransferTarget.waitForCallEvent(g_hAutoRejectCallbackLine, g_hAutoRejectCallbackCall, CALLSTATE_DISCONNECTED, CALLSTATE_CAUSE_REJECTED);
      CPPUNIT_ASSERT(bRC);
...
void sipXtapiTestSuite::testTransferSuccess()
{
   ...
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      resetAutoAnswerCallback();
      resetAutoAnswerCallback2();
      sipxRC = sipxEventListenerAdd(g_hInst1, UniversalEventValidatorCallback, &validatorSource);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      ...
      // Setup call to transfer source (transferee)
      sipxRC = sipxCallCreate(g_hInst1, hLine, &hCallSource);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      ...
      CPPUNIT_ASSERT(bRC);
      validatorSource.validateCallMediaStartEvents();
      ...
      sipxRC = sipxCallCreate(g_hInst1, hLine, &hCallTarget);        
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      ...
      CPPUNIT_ASSERT(bRC);
      validatorSource.validateCallMediaStopEvents();
      validatorSource.validateCallMediaStopEvents();
      ...
      // Remove Listeners
      sipxRC = sipxEventListenerRemove(g_hInst1, UniversalEventValidatorCallback, &validatorSource);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
...
void sipXtapiTestSuite::testTransferConferenceSuccess()
{
   ...
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      // Create Conference
      sipxRC = sipxConferenceCreate(g_hInst1, &hConf);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
...

{
   ...
   */ 
   ...
   CPPUNIT_ASSERT(bRC);
   validatorTC.validateCallMediaStopEvents();
   ...
   */
   ...
   if (!bTargetOnHold)
   {
      validatorTT.validateCallMediaStopEvents();
   }
   ...
   if (!bTargetOnHold)
   {
      validatorTT.validateCallMediaStartEvents();
   ...
   */ 
   // Original Call
   bRC = validatorTE.waitForCallEvent(hLineTE, hTE, CALLSTATE_BRIDGED, CALLSTATE_CAUSE_NORMAL, false);
   CPPUNIT_ASSERT(bRC);
   validatorTE.validateCallMediaStopEvents();
                                             ...
                                             SIPX_LINE hLine2) 
{
   ...
   */
   validatorCall1.validateCallMediaStopEvents();
   ...
   * Validate Call2
   */
   validatorCall2.validateCallMediaStopEvents();
...
// 1. Party A calls Party B, Party B Confs A&C, Party C Confs B&D (A -> B -> C -> D)
...
void sipXtapiTestSuite::testChainedConfTransfer1() 
{
   ...
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      */
      doCallBasicSetup(g_hInst1, HINST_ADDRESS, HINST_ADDRESS,
      ...
      */ 
      ...
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      CPPUNIT_ASSERT(sipxCallHold(hCallPartyB, TRUE) == SIPX_RESULT_SUCCESS);
      OsTask::delay(CALL_DELAY);
      sipxRC = sipxConferenceJoin(hConfPartyB, hCallPartyB);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      CPPUNIT_ASSERT(sipxCallUnhold(hCallPartyB, TRUE) == SIPX_RESULT_SUCCESS);
      OsTask::delay(CALL_DELAY);
      ...
      */ 
      ...
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      CPPUNIT_ASSERT(sipxCallHold(hCallPartyC, TRUE) == SIPX_RESULT_SUCCESS);
      OsTask::delay(CALL_DELAY);
      sipxRC = sipxConferenceJoin(hConfPartyC, hCallPartyC);
      CPPUNIT_ASSERT(sipxRC == SIPX_RESULT_SUCCESS);
      CPPUNIT_ASSERT(sipxCallUnhold(hCallPartyC, TRUE) == SIPX_RESULT_SUCCESS);
      OsTask::delay(CALL_DELAY);
      ...
      */
      ...
      doConfTransfer(g_hInst2, hCallPartyB, hCallPartyB_C, hLinePartyB,
         g_hInst1, hCallPartyA, hLinePartyA, 
      ...
      */
      ...
      doConfTransfer(g_hInst3, hNewPartyC_PartyA, hCallPartyC_D, hLinePartyC,
         g_hInst1, hNewPartyA_PartyC, hLinePartyA, 
      ...
      * Hangup A -> D
      */
      doDestroyActiveCalls(g_hInst1, hNewPartyA_PartyD, hLinePartyA, true, g_hInst4, hNewPartyD_PartyA, hLinePartyD);

      doRemoveProvisionedLine(g_hInst1, hLinePartyA);
                                               ...
                                               SIPX_LINE hLineConf)
{
   ...
   * Validate Call
   */ 
   validatorCall.validateCallMediaStopEvents();
   ...
   * Validate Conf
   */
   validatorConf.validateCallMediaStopEvents();
                                           ...
                                           SIPX_LINE hLineConf) 
{
   ...
   * Validate Call
   */ 
   validatorRemote.validateCallMediaStopEvents(MEDIA_CAUSE_HOLD);
   ...
   * Validate Conf
   */
   validatorConf.validateCallMediaStopEvents(MEDIA_CAUSE_HOLD);
...
void sipXtapiTestSuite::testChainedConfTransfer2()
{
   ...
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      * Hang up Party A 
      */
      doDestroyOneCallInConf(g_hInst1, hNewPartyA_PartyC, hLinePartyA,
                                        ...
                                        SIPX_LINE hLineLocal)
{
   ...
   * Validate Events
   */
   validatorRemote.validateCallMediaStartEvents(MEDIA_CAUSE_UNHOLD);
   bRC = validatorRemote.waitForCallEvent(hLineRemote, hCallRemote, CALLSTATE_CONNECTED, CALLSTATE_CAUSE_NORMAL);
   CPPUNIT_ASSERT(bRC);

   validatorLocal.validateCallMediaStartEvents(MEDIA_CAUSE_UNHOLD);
...
void sipXtapiTestSuite::testChainedConfTransfer3()
{
   ...
   for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
   {
      ...
      * Hangup C -> D
      */
      doDestroyActiveCalls(g_hInst3, hNewPartyC_PartyA, hLinePartyC, true, g_hInst1, hNewPartyA_PartyC, hLinePartyA);
