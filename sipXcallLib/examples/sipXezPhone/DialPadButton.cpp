...
// Constructor
DialPadButton::DialPadButton(wxWindow* parent, int id, const wxBitmap& bitmap, const wxPoint& pos, const wxSize& size, const SIPX_TONE_ID toneId, const char charVal) :
