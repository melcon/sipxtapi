...
#ifndef _MpeSipxG726_h_
#define _MpeSipxG726_h_
...
/// Derived class for G.726 encoder.
class MpeSipxG726 : public MpEncoderBase
{
/* //////////////////////////// PUBLIC //////////////////////////////////// */
public:
...
//@{
   typedef enum
   {
     ...
     /// Constructor
   MpeSipxG726(int payloadType, G726_BITRATE bitRate);
     /**<
