...
MpeIPPPcma::MpeIPPPcma(int payloadType)
...
MpeIPPPcma::~MpeIPPPcma()
{
   freeEncode();
   free(m_pCodec);
}

OsStatus MpeIPPPcma::initEncode(void)
{
   int lCallResult;
...
OsStatus MpeIPPPcma::freeEncode(void)
{
...
OsStatus MpeIPPPcma::encode(const short* pAudioSamples,
...
const MpCodecInfo* MpeIPPPcma::getCodecInfo()
{
   return &ms_codecInfo;
}

const MpCodecInfo MpeIPPPcma::ms_codecInfo(
