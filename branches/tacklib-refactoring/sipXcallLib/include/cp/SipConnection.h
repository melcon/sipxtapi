...
protected:
    ...
    UtlBoolean processRequest(const SipMessage* request, UtlBoolean callInFocus);
    ...
    UtlBoolean processResponse(const SipMessage* response, UtlBoolean callInFocus);
...
private:
    ...
    OsTimer* mpRenegotiateCodecsTimer;
    OsTimer* mpReinviteTimer1;
    OsTimer* mpReinviteTimer2;
    OsTimer* mpReinviteTimer3;
    OsTimer* mpForceDropConnectionTimer1;
    OsTimer* mpForceDropConnectionTimer2;
