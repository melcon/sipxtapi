 ...
 * highest.
 * 
 * LOG_DEBUG - Debug-level message.  Debug level messages should
 ...
 * LOG_INFO - Informational message.  Informational messages
 ...
 * LOG_NOTICE - Normal, but significant, condition.  Notices are
 ...
 * LOG_WARNING - Warning conditions.  Warnings tend to be minor
 ...
 * LOG_ERR - Error conditions.  Error should be used whenever an
 *            expected error is observed and some minor amount of
 *            functionality is lost.
 *            Example: Unknown/Invalid command received.
 * LOG_CRIT - Critical conditions.  Critial errors are errors
 ...
 * LOG_ALERT - Action must be taken immediately.  ALERTs are
 ...
 * LOG_EMERG - System is unusable.  The worst possible error
...
public:
    ...
    * 
    * OPT_NONE - No Extra Options
    * OPT_SHARED_LOGFILE - Places the OsSysLog in a mode where
...
/* ============================ MANIPULATORS ============================== */
   ...
   /** Shutdown the OsSysLog task. Not thread safe. */
