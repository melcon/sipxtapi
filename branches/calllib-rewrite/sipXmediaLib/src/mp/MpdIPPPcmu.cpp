...
MpdIPPPcmu::MpdIPPPcmu(int payloadType)
...
MpdIPPPcmu::~MpdIPPPcmu()
{
   freeDecode();
   free(m_pCodec);
}

OsStatus MpdIPPPcmu::initDecode()
{
   int lCallResult;
...
OsStatus MpdIPPPcmu::freeDecode(void)
{
   // Free codec memory
...
int MpdIPPPcmu::decode(const MpRtpBufPtr &rtpPacket,
...
void MpdIPPPcmu::configureBitStream(int rtpPayloadBytes)
{
...
const MpCodecInfo* MpdIPPPcmu::getCodecInfo()
{
   return &ms_codecInfo;
}

const MpCodecInfo MpdIPPPcmu::ms_codecInfo(
