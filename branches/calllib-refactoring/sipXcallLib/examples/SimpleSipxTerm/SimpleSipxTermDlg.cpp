...
BOOL CSimpleSipxTermDlg::OnInitDialog()
{
  ...
  lv_LogStr.Format("Creating sipXtapi instance (local SIP-port=%d, RTP-port=%d",
    m_SipPort, m_RtpPort);
  m_LogList.AddString(lv_LogStr);

  lv_Result = sipxInitialize( &this->m_sipXInstance,            
                              this->m_SipPort,    // UDP
                              this->m_SipPort,    // TCP
  ...
  if ( SIPX_RESULT_SUCCESS == lv_Result )
  {
    ...
    m_LogList.AddString("-> OK. Register callback");
    ...
    if ( m_NrOfAccounts >= 1 )
    {
      m_Lines[0].m_Dnr.Format("%d", m_StartDnr);

      // Create the window
  	  m_Lines[0].m_PhoneDlg = new CSipPhoneDlg( NULL, this );
      m_Lines[0].m_PhoneDlg->Create( IDD_SIPPHONE );
      m_Lines[0].m_PhoneDlg->SetParentHwnd(this->m_hWnd );

      // Get the dialog's sizes (only here for the first time). 
      // We're using the right+bottom for width and heigth
      m_Lines[0].m_PhoneDlg->GetWindowRect( &lv_DlgRect );
      lv_DlgRect.right  = lv_DlgRect.right  - lv_DlgRect.left;
      lv_DlgRect.bottom = lv_DlgRect.bottom - lv_DlgRect.top;

      lv_ViewRect.left += 10;
      m_Lines[0].m_PhoneDlg->MoveWindow( lv_ViewRect.left, 
                                         0,
                                         lv_DlgRect.right,
                                         lv_DlgRect.bottom );
      ...
      if ( SIPX_RESULT_SUCCESS == lv_Result )
      {
        ...
        sipxLineAddCredential( m_Lines[0].m_SipLine , lv_String, "", "" );
      
        lv_LogStr.Format("  --> sipxLineRegister (%d)", m_Lines[0].m_SipLine);
        m_LogList.AddString(lv_LogStr);

        lv_Result = sipxLineRegister( m_Lines[0].m_SipLine  , false);
        Sleep(250);
        lv_Result = sipxLineRegister( m_Lines[0].m_SipLine  , true);

        if ( SIPX_RESULT_SUCCESS == lv_Result )
        {
          // All success. Now copy info to Phone dialog and show it
          m_Lines[0].m_PhoneDlg->SetConfig( 0, m_StartDnr );
          m_Lines[0].m_Activated = true;

          lv_String.Format("DNR: %s (Registring...)",m_Lines[0].m_Dnr);
          m_Lines[0].m_PhoneDlg->SetWindowText(lv_String);

          m_Lines[0].m_PhoneDlg->m_LowerDisplay.SetWindowText("Trying to register...");

          if ( NULL != m_Lines[0].m_PhoneDlg ) m_Lines[0].m_PhoneDlg->ShowWindow( SW_SHOW );
      ...
      if ( true == lv_Abort )
      {
        try
        {
          if ( m_Lines[0].m_SipLine != 0 )
            sipxLineRemove( m_Lines[0].m_SipLine );
        }
        catch(...)
        {
        }
    ...
    if ( m_NrOfAccounts >= 2 )
    {
      // First increase the StartDNR
      m_StartDnr++;
      m_Lines[1].m_Dnr.Format("%d", m_StartDnr);

  	  m_Lines[1].m_PhoneDlg = new CSipPhoneDlg( NULL, this );
      m_Lines[1].m_PhoneDlg->Create( IDD_SIPPHONE );
      m_Lines[1].m_PhoneDlg->SetParentHwnd(this->m_hWnd );
      ...
      {
        lv_String.Format("%d", m_StartDnr);
        sipxLineAddCredential( m_Lines[1].m_SipLine , lv_String, "", "" );
      
        lv_LogStr.Format("  --> sipxLineRegister (%d)", m_Lines[1].m_SipLine);
        m_LogList.AddString(lv_LogStr);

        lv_Result = sipxLineRegister( m_Lines[1].m_SipLine  , false);
        Sleep(250);
        lv_Result = sipxLineRegister( m_Lines[1].m_SipLine  , true);

        if ( SIPX_RESULT_SUCCESS == lv_Result )
        {
          // All success. Now copy info to Phone dialog and show it
          m_Lines[1].m_PhoneDlg->SetConfig( 1, m_StartDnr );
          m_Lines[1].m_Activated = true;

          lv_String.Format("DNR: %s (Registring...)",m_Lines[1].m_Dnr);
          m_Lines[1].m_PhoneDlg->SetWindowText(lv_String);
          m_Lines[1].m_PhoneDlg->m_LowerDisplay.SetWindowText("Trying to register...");


          lv_ViewRect.left += (lv_DlgRect.right - lv_DlgRect.left + 10);
          m_Lines[1].m_PhoneDlg->MoveWindow( lv_ViewRect.left , 
                                             0,
                                             lv_DlgRect.right,
                                             lv_DlgRect.bottom );


          if ( NULL != m_Lines[1].m_PhoneDlg ) m_Lines[1].m_PhoneDlg->ShowWindow( SW_SHOW );
      ...
      if ( true == lv_Abort )
      {
        try
        {
          if ( m_Lines[1].m_SipLine != 0 )
            sipxLineRemove( m_Lines[1].m_SipLine );
        }
        catch(...)
        {
        }
    ...
    if ( m_NrOfAccounts >= 3 )
    {
      // First increase the StartDNR
      m_StartDnr++;
      m_Lines[2].m_Dnr.Format("%d", m_StartDnr);

  	  m_Lines[2].m_PhoneDlg = new CSipPhoneDlg( NULL, this );
      m_Lines[2].m_PhoneDlg->Create( IDD_SIPPHONE );
      m_Lines[2].m_PhoneDlg->SetParentHwnd(this->m_hWnd );
      ...
      {
        lv_String.Format("%d", m_StartDnr);
        sipxLineAddCredential( m_Lines[2].m_SipLine , lv_String, "", "" );
      
        lv_LogStr.Format("  --> sipxLineRegister (%d)", m_Lines[2].m_SipLine);
        m_LogList.AddString(lv_LogStr);

        lv_Result = sipxLineRegister( m_Lines[2].m_SipLine  , false);
        Sleep(250);
        lv_Result = sipxLineRegister( m_Lines[2].m_SipLine  , true);

        if ( SIPX_RESULT_SUCCESS == lv_Result )
        {
          // All success. Now copy info to Phone dialog and show it
          m_Lines[2].m_PhoneDlg->SetConfig( 2, m_StartDnr );
          m_Lines[2].m_Activated = true;

          lv_String.Format("DNR: %s (Registring...)",m_Lines[2].m_Dnr);
          m_Lines[2].m_PhoneDlg->SetWindowText(lv_String);
          m_Lines[2].m_PhoneDlg->m_LowerDisplay.SetWindowText("Trying to register...");

          lv_ViewRect.left += (lv_DlgRect.right - lv_DlgRect.left + 10);
          m_Lines[2].m_PhoneDlg->MoveWindow( lv_ViewRect.left , 
                                             0,
                                             lv_DlgRect.right,
                                             lv_DlgRect.bottom );

          if ( NULL != m_Lines[2].m_PhoneDlg ) m_Lines[2].m_PhoneDlg->ShowWindow( SW_SHOW );
      ...
      if ( true == lv_Abort )
      {
        try
        {
          if ( m_Lines[2].m_SipLine != 0 )
            sipxLineRemove( m_Lines[2].m_SipLine );
        }
        catch(...)
        {
        }
    ...
    if ( m_NrOfAccounts >= 4 )
    {
      // First increase the StartDNR
      m_StartDnr++;
      m_Lines[3].m_Dnr.Format("%d", m_StartDnr);

  	  m_Lines[3].m_PhoneDlg = new CSipPhoneDlg( NULL, this );
      m_Lines[3].m_PhoneDlg->Create( IDD_SIPPHONE );
      m_Lines[3].m_PhoneDlg->SetParentHwnd(this->m_hWnd );
      ...
      {
        lv_String.Format("%d", m_StartDnr);
        sipxLineAddCredential( m_Lines[3].m_SipLine , lv_String, "", "" );
      
        lv_LogStr.Format("  --> sipxLineRegister (%d)", m_Lines[3].m_SipLine);
        m_LogList.AddString(lv_LogStr);

        lv_Result = sipxLineRegister( m_Lines[3].m_SipLine  , false);
        Sleep(250);
        lv_Result = sipxLineRegister( m_Lines[3].m_SipLine  , true);

        if ( SIPX_RESULT_SUCCESS == lv_Result )
        {
          // All success. Now copy info to Phone dialog and show it
          m_Lines[3].m_PhoneDlg->SetConfig( 3, m_StartDnr );
          m_Lines[3].m_Activated = true;
          m_Lines[3].m_PhoneDlg->m_LowerDisplay.SetWindowText("Trying to register...");

          lv_ViewRect.left += (lv_DlgRect.right - lv_DlgRect.left + 10);
          m_Lines[3].m_PhoneDlg->MoveWindow( lv_ViewRect.left , 
                                             0,
                                             lv_DlgRect.right,
                                             lv_DlgRect.bottom );


          if ( NULL != m_Lines[3].m_PhoneDlg ) m_Lines[3].m_PhoneDlg->ShowWindow( SW_SHOW );
      ...
      if ( true == lv_Abort )
      {
        try
        {
          if ( m_Lines[3].m_SipLine != 0 )
            sipxLineRemove( m_Lines[3].m_SipLine );
        }
        catch(...)
        {
        }
...
void CSimpleSipxTermDlg::OnDestroy() 
{
  ...
  if ( m_Lines[0].m_PhoneDlg != NULL )
  {
    try
    {
      sipxLineRegister( m_Lines[0].m_SipLine, false);
      m_Lines[0].m_PhoneDlg->DestroyWindow();
      delete( m_Lines[0].m_PhoneDlg );
    }
    catch(...)
    {
    }
  }	
  if ( m_Lines[1].m_PhoneDlg != NULL )
  {
    try
    {
      sipxLineRegister( m_Lines[1].m_SipLine, false);
      m_Lines[1].m_PhoneDlg->DestroyWindow();
      delete( m_Lines[1].m_PhoneDlg );
    }
    catch(...)
    {
    }
  }	
  if ( m_Lines[2].m_PhoneDlg != NULL )
  {
    try
    {
      sipxLineRegister( m_Lines[2].m_SipLine, false);
      m_Lines[2].m_PhoneDlg->DestroyWindow();
      delete( m_Lines[2].m_PhoneDlg );
    }
    catch(...)
    {
    }
  }	
  if ( m_Lines[3].m_PhoneDlg != NULL )
  {
    try
    {
      sipxLineRegister( m_Lines[3].m_SipLine, false);
      m_Lines[3].m_PhoneDlg->DestroyWindow();
      delete( m_Lines[3].m_PhoneDlg );
    }
    catch(...)
    {
    }
                                    ...
                                    const CString&  fi_DestDnr )
{
  ...
  if ( lv_LineInfo.m_ActiveCall == SIPX_CALL_NULL )
  {
    ...
    if ( SIPX_RESULT_SUCCESS == lv_Result )
    {
//      lv_Destination.Format("sip:%s@%s:%d",
//        fi_DestDnr, m_SipServerIP, m_SipServerPort);
      ...
      if ( SIPX_RESULT_SUCCESS == lv_Result )
      {
          ...
          lv_LineInfo.m_PhoneDlg->m_UpperDisplay.SetWindowText( lv_String );
      ...
      else
      {
        ...
        lv_LineInfo.m_PhoneDlg->m_UpperDisplay.SetWindowText( "" );
      }
    }
    else
    {
...
void CSimpleSipxTermDlg::HoldUnholdCall ( int  fi_PhoneIndex )
{
     ...
     )
  {
      ...
      if ( SIPX_RESULT_SUCCESS == lv_Result )
      {
        ...
        lv_LineInfo.m_PhoneDlg->m_LowerDisplay.SetWindowText(lv_String);
      }
      else
      {
       ...
       )
    {
      ...
      if ( SIPX_RESULT_SUCCESS == lv_Result )
      {
        ...
        if ( SIPX_RESULT_SUCCESS == lv_Result )
        {
          ...
          lv_LineInfo.m_PhoneDlg->m_UpperDisplay.SetWindowText(lv_LowerStr);
        }
        else
        {
    ...
    else
    {
         ...
         )
      {
        ...
        if ( SIPX_RESULT_SUCCESS == lv_Result )
        {
          ...
          lv_LineInfo.m_PhoneDlg->m_LowerDisplay.SetWindowText("");
...
( 
  ...
  void*                fi_pInfo,
  void*                fi_pSipXWrapper
)
{
    CSimpleSipxTermDlg* lv_ThisPtr = (CSimpleSipxTermDlg*)fi_pSipXWrapper;
    SIPX_LINE           lv_Line;
...
)
{
    ...
    case CALLSTATE_ALERTING:
        ...
        m_Lines[fi_LineAdmIndex].m_PhoneDlg->m_UpperDisplay.SetWindowText( lv_String );
    ...
    case CALLSTATE_DISCONNECTED:
        ...
        if ( m_Lines[fi_LineAdmIndex].m_ActiveCall  == lv_ThisCall )
        {
            ...
            m_Lines[fi_LineAdmIndex].m_PhoneDlg->m_UpperDisplay.SetWindowText( "" );
        ...
        else
        {
            ...
            {
                m_Lines[fi_LineAdmIndex].m_PhoneDlg->m_LowerDisplay.SetWindowText( lv_String );
    ...
    case CALLSTATE_DESTROYED:
        ...
        {
          m_Lines[fi_LineAdmIndex].m_PhoneDlg->m_UpperDisplay.SetWindowText( "" );
          m_Lines[fi_LineAdmIndex].m_PhoneDlg->m_LowerDisplay.SetWindowText( "" );
...
)
{
    ...
    case LINESTATE_REGISTERED:
        ...
        if (m_Lines[fi_LineAdmIndex].m_FirstTime)
        {
          m_Lines[fi_LineAdmIndex].m_State     = TS_ON_HOOK;
          m_Lines[fi_LineAdmIndex].m_PhoneDlg->m_LowerDisplay.SetWindowText("Registered. Ready for use.");
          m_Lines[fi_LineAdmIndex].m_FirstTime = false;
        }
      break;
    ...
    case LINESTATE_REGISTER_FAILED:
        ...
        m_Lines[fi_LineAdmIndex].m_PhoneDlg->SetWindowText(lv_String);
        m_Lines[fi_LineAdmIndex].m_PhoneDlg->m_LowerDisplay.SetWindowText("Registration failed. Please close...");
        break;
