...
unsigned int CpCallIdGenerator::ms_instanceCounter = 0;
...
CpCallIdGenerator::CpCallIdGenerator(const UtlString& prefix) : m_callIdCounter(0)
, m_sPrefix(prefix)
...
CpCallIdGenerator::~CpCallIdGenerator(void)
{
...
UtlString CpCallIdGenerator::getNewCallId()
{
