              ...
              s_rr *ptr)
{
   ...
   */
   ...
   res_time(buffer, sizeof(buffer), ptr->ttl);
   if ( ptr->type == T_SOA )
      fprintf(fp, "\tttl = %d (%s)\n", (int)ptr->ttl, buffer);
   ...
   */
   switch(ptr->type) {
        ...
        case T_SOA:                             /* Start of Authority */
           ...
           fprintf(fp, "\tserial = %d\n", (int)rd->soa.serial);
           res_time(buffer, sizeof(buffer), rd->soa.refresh);
           fprintf(fp, "\trefresh = %d (%s)\n",
              (int)rd->soa.refresh, buffer);
           res_time(buffer, sizeof(buffer), rd->soa.retry);
           fprintf(fp, "\tretry = %d (%s)\n",
              (int)rd->soa.retry, buffer);
           res_time(buffer, sizeof(buffer), rd->soa.expire);
           fprintf(fp, "\texpire = %d (%s)\n",
              (int)rd->soa.expire, buffer);
           res_time(buffer, sizeof(buffer), rd->soa.minimum);
           fprintf(fp, "\tminimum ttl = %d (%s)\n",
              (int)rd->soa.minimum, buffer);
           break;
