...
void SipSession::getCallId( UtlString& callId ) const
{
    callId = data();
}
...
void SipSession::getFromUrl( Url& fromUrl ) const
{
    fromUrl = mLocalUrl;
}
...
void SipSession::getToUrl( Url& toUrl ) const
{
    toUrl = mRemoteUrl;
}
...
void SipSession::getRemoteContact( Url& remoteContact ) const
{
...
void SipSession::getLocalContact( Url& localContact ) const
{
...
void SipSession::getLocalRequestUri( UtlString& requestUri ) const
{
...
void SipSession::getRemoteRequestUri( UtlString& requestUri ) const
{
...
void SipSession::getContactRequestUri( UtlString& requestContactUri ) const
{
...
void SipSession::getInitialMethod( UtlString& method ) const
{
...
int SipSession::getLastFromCseq() const
{
...
int SipSession::getLastToCseq() const
{
    return(mLastToCseq);
}
